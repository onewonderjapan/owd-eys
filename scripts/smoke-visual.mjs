...
for (const f of ['meeting-pov', 'voting', 'vote-result', 'water-self', 'water-self-look-down', 'water-npc', 'fire-self', 'fire-self-lit', 'fire-npc', 'ring-pov', 'corpse-close', 'report-pov', 'voting-dead'])
