...
先从 27 位角色中选择同行者，再进入鹅教堂小镇。WASD／方向键移动，E 查看位置，Esc 更换角色；手机提供方向键。当前为单人场景探索，不包含原作完整规则或联机玩法。
...
地图几何来自已交付 map_reference_v2，角色来自衣橱 4.3.27。角色装配、碰撞和渲染按模块分离，生成计算仍在 S1。运行、发布资料见 [docs/DEPLOYMENT.md](docs/DEPLOYMENT.md)。
